...
admin.prototype.cadastroProduto = function (dados, callback) {
    this._conexao.query(`insert into item values(null,'${dados.descricao}','${dados.preco}', '${dados.estoque}', '${dados.codigo}', '${dados.codigoBarra}', '${dados.idCategoria}','${dados.vendedor}', '${dados.status})`, dados, callback)
}
